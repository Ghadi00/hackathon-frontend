...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen w-full bg-[#F7F8FA]" style={{ fontFamily: "'Inter', sans-serif" }}>
      {/* Sidebar */}
      <aside
        ...
        <div className="px-6 py-6 border-b border-[#E8E9ED]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span style={{ fontSize: '12px', fontWeight: 400, color: '#6B7085', marginLeft: '4px' }}>Analytics</span>
            </div>
          </div>
        </div>
      ...
      <button
        ...
        className="fixed left-0 top-[50%] -translate-y-1/2 z-50 bg-white border border-[#E8E9ED] rounded-r-lg shadow-sm hover:bg-[#F7F8FA] transition-all duration-300 ease-in-out"
        style={{
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-[56px] min-h-[56px] bg-white border-b border-[#E8E9ED] flex items-center justify-between px-8">
          <h1 style={{ fontSize: '17px', fontWeight: 600, color: '#1A1D26', lineHeight: '1.2' }}>
            {pageTitle}
          </h1>
