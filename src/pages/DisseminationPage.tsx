                        ...
                        <div className="flex items-center gap-3">
                            {["Last 30 days", "6 months", "12 months"].map((r) => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-md transition-colors cursor-pointer ${timeRange === r ? "bg-[#3B82A0] text-white" : "border border-[#DDE0E7] text-[#4A4E5F] hover:bg-[#F3F4F6]"
                                        }`}
                    ...
                    <div className="flex items-center gap-4 mb-5">
                        {CHANNELS.map((c, i) => (
                            <button
                                ...
                                className={`flex items-center gap-1.5 px-2.5 py-1 rounded-md transition-all cursor-pointer ${activeLine[c] ? "opacity-100" : "opacity-40"
                                    }`}
